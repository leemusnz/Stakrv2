      ...
      <Card className="w-full max-w-md border-destructive/50">
        <CardHeader>
          <div className="flex items-center gap-2 text-destructive">
            ...
            <CardTitle>Challenge Load Failed</CardTitle>
          </div>
          <CardDescription>Unable to load the challenge details</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <p className="text-sm text-muted-foreground">
            We had trouble loading this challenge. Please try again, or return to discover more challenges.
          </p>
          {error.message && (
