    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-b from-background to-secondary/20 px-4">
      <Card className="w-full max-w-md border-destructive/50">
        <CardHeader>
          ...
          <CardDescription>Unable to load the admin panel</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <p className="text-sm text-muted-foreground">
            We encountered an error loading the admin panel. Please try again to access admin functions.
          </p>
          {error.message && (
