-- 🚨 PRODUCTION FIX: Apply this to your Neon database immediately
-- This fixes the "Unable to create account" error by adding missing email verification schema
...
SELECT 'Email verification schema applied successfully!' as status; 